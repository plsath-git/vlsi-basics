module rising_edge_detector_syncrstn_moore
  (input  rstn,
   input  clk,
   input  pulse_in,
   ...
   always @(*) begin
      ...
      case (crnt_state)
	S0: next_state = pulse_in ? S1 : S0;
	S1: next_state = pulse_in ? S2 : S0;
	S2: next_state = pulse_in ? S2 : S0;
...
endmodule // rising_edge_detector_syncrstn_moore
